...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/raspy-night-f938#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-night-f938
```

A live public deployment of this template is available at [https://raspy-night-f938.templates.workers.dev](https://raspy-night-f938.templates.workers.dev)
